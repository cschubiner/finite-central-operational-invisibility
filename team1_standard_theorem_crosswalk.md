...
`team1_quantitative_readout_accountability_note.md`; the compact TeX/PDF
review version is
`team1_quantitative_readout_accountability_short_note.tex` /
...
test in `team1_lcqft_dynamical_locality_question.md` and
`team1_lcqft_constant_center_extension_note.md`.  A reviewer can kill it
...
nonmaximality test in
`team1_dhr_dr_sector_faithfulness_question.md` and
...
`team1_quantitative_readout_accountability_note.md`, with the standalone
short note `team1_quantitative_readout_accountability_short_note.pdf`.
...
`team1_two_week_theorem_or_demotion_sprint.md`; it prioritizes the
