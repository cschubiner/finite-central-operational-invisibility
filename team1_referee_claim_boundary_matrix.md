...
`team1_lcqft_dynamical_locality_question.md`; details are in
...
`team1_oaqec_jlms_maximality_question.md`.
For the concrete DHR/DR sector-character nonmaximality test, see
`team1_dhr_dr_sector_faithfulness_question.md`; details are in
...
`team1_quantitative_readout_accountability_note.md` and the standalone
review PDF `team1_quantitative_readout_accountability_short_note.pdf`.
...
| Noisy readout accountability needs an error budget | A standard AQFT/OAQEC/spectroscopy setup supplies a lower readout modulus, Le Cam/deficiency bound, or line-resolution estimate; the concrete target is `team1_quantitative_readout_accountability_note.md`. | Formal rank is not enough for a finite-precision finite-center or `q=2` claim; the separation margin must dominate the uncertainty. |
...
send `team1_lcqft_dynamical_locality_question.md` first; if the reviewer
wants details, add `team1_lcqft_constant_center_extension_note.md` plus
the compact short note `team1_lcqft_constant_center_short_note.pdf`.
For the OAQEC/JLMS lane, send
`team1_oaqec_jlms_maximality_question.md` first; if the reviewer wants
details, add
`team1_oaqec_jlms_algebra_relative_nonmaximality_note.md` plus the compact
short note
`team1_oaqec_jlms_algebra_relative_nonmaximality_short_note.pdf`.
For the DHR/DR lane, send
`team1_dhr_dr_sector_faithfulness_question.md` first; if the reviewer
wants details, add `team1_dhr_dr_sector_character_nonmaximality_note.md`
...
`team1_quantitative_readout_accountability_note.md` plus the compact short
note `team1_quantitative_readout_accountability_short_note.pdf`.
